...
if __name__ == '__main__':
    ...
    lc_quad_dir = os.path.join(data_dir, 'qald')
    ...
    parser = QaldParser()
    train_filepath = './data/QALD/qald-9-train.json'
    ...
    build_vocab(
        ...
        os.path.join(lc_quad_dir, 'vocabqald.txt'))
    build_vocab(
        glob.glob(os.path.join(lc_quad_dir, '*/*.toks')),
        os.path.join(lc_quad_dir, 'vocab-cased-qald.txt'),
        lowercase=False)
