...
class Orchestrator:
    def __init__(self, logger, question_classifier, double_relation_classifer, parser, filepath, auto_train=True):
        ...
        self.dep_tree_cache_file_path = './caches/dep_tree_cache_qald.json'
    ...
    def generate_query(self, question, entities, relations, h1_threshold=9999999, question_type=None):
        ...
        args.expname = "lc_quad,epoch=15,train_loss=0.20816799998283386"
        args.mem_dim = 150
        args.hidden_dim = 50
        args.num_classes = 2
        args.input_dim = 768
...
if __name__ == "__main__":
    ...
    linker = Earl(path="data/QALD/test/entityww_qaldtestfromSQLtestclassquer.json")
    #linker = GoldLinker()
