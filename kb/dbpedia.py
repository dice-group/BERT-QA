...
class DBpedia(KB):
    def __init__(self, endpoint="http://dbpedia.org/sparql",
        ...
        if os.path.exists(two_hop_bloom_file):
    ...
    def one_hop_graph(self, entity1_uri, relation_uri, entity2_uri=None):
        if self.one_hop_bloom is not None:
            # print('self.one_hop_bloom is not None')
            ...
            # print('self.one_hop_bloom is None')
    ...
    def two_hop_graph(self, entity1_uri, relation1_uri, entity2_uri, relation2_uri):
        if self.two_hop_bloom is not None:
            # print('self.two_hop_bloom is not None')
            ...
            # print('self.two_hop_bloom is None')
            return super(DBpedia, self).two_hop_graph(entity1_uri, relation1_uri, entity2_uri, relation2_uri)
    ...
    def two_hop_graph_template(self, entity1_uri, relation1_uri, entity2_uri, relation2_uri):
        ...
        if self.one_hop_bloom is not None:
            ...
            return super(DBpedia, self).two_hop_graph_template(entity1_uri, relation1_uri, entity2_uri, relation2_uri)
