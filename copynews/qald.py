...
from copynews.answerparser import AnswerParser

import sys


class Qald:
    qald_7 = "./data/QALD/qald-7-train-multilingual - Copy.json"
    qald_9_train = "D:/downloads/QA/data/QALD/qald-9-train.json"
    qald_9_test = "D:/downloads/QA/data/QALD/qald-9-test.json"
    #qald_7 = "./data/QALD/9/data/test.json"
